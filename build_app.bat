...
echo     sys.argv = ["streamlit", "run", "C:\\Users\\Michael_Liu\\mypvapp\\app18.py", "--server.headless=false", "--global.developmentMode=false", "--server.enableStaticServing=true"] >> run_app.py
...
--add-data "%VIRTUAL_ENV%\Lib\site-packages\streamlit\static;streamlit\static" ^
run_app.py
